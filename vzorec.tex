...
% - sumniki:
%     Če vaš urejevalnik pod Windows ne pozna Unicodea (ostali ga že),
...
% Če želite v eni datoteki ustvariti več izpitov, ukaz pokličite večkrat.
%
...
%     304, 305, 306, 307, 310, 311, 312, F1, MFP in VFP. Povejte, katere
%     učilnice bi še potrebovali. Za idejo in pomoč pri izdelavi se
%     zahvaljujem Alešu Vavpetiču in Jaki Smekarju.
% - sedezni red:
%     Če Na shemi učilnice so dovoljeni sedeži odebeljeni.
% - naloge:
...
\izpit[ucilnica = 204, sedezni red, naloge = 3]
  {Diskretna algebraična analiza: 2. izpit}{10. 10. 2010}{
...
% 'točke' (oz 'points') s primerno končnico: \tocke{5} zapiše 5 točk,
...
\naloga[\tocke{25}]
  ...
  \prostor[2] % Ta naloga bo imela na voljo dvakrat toliko prostora kot druga.
...
% na isto stran, uporabite ukaz \dodatnanaloga, ki se obnaša enako kot
% \naloga, le da ne naredi nove strani.
\dodatnanaloga[brez točk]
